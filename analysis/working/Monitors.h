...
class Monitors : public TSelector {
    public :
        ...
        int numCol_; // number of detector in same side
        int numRow_; // number of sides

        bool isArrayTraceExist_;
        bool isRDTTraceExist_;
        ...
        int printControlID_;
        void printControl(int n){this->printControlID_ = n;}

        DetGeo detGeo_;
        ReactionConfig reactionConfig_;
